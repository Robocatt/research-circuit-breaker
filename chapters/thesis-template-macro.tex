...
\usepackage{xltxtra} % \XeLaTeX macro. marked as OBSOLETE
\usepackage{fontspec}
...
\ifwindows
  % Define main fonts first
  \setmainfont{Times New Roman}
  \setsansfont{Arial}
  \setmonofont{Courier New}
  % Define Cyrillic-specific fonts for polyglossia
...
% set polyglossia AFTER fonts is crucial 
...
\lstdefinelanguage{dockerfile}{
  ...
  comment=[l]{\#},          % shell-style comments
  morestring=[b]",
}

\makeatletter
  \def\lst@ext{}            % <- empty means: never append ".tex"
\makeatother
